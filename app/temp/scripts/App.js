...
new _RevealOnScroll2.default((0, _jquery2.default)(".sample"), "85%");
...
var StickyHeader = function () {
	...
	_createClass(StickyHeader, [{
		...
		key: 'createHeadWaypoint',
		value: function createHeadWaypoint() {
			var that = this;
			new Waypoint({
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == "down") {
							...
							(0, _jquery2.default)(headerLink).addClass('is-current-link');
						}
					},
					offset: "20%"
				});
...
var RandomQuote = function () {
  function RandomQuote() {
    ...
    this.newQuoteBtn = (0, _jquery2.default)('#quote');
    this.events();
  }
